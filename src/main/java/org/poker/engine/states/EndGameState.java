...
public class EndGameState implements IState<ModelContext> {
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(EndGameState.class);
    public static final String NAME = "EndGame";
    ...
    public boolean execute(ModelContext model) {
        ...
        double scoreTotal = scores.values().stream().reduce(0., (accumulator, _item) -> accumulator + _item);
